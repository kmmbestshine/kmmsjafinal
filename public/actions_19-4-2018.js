...
function openFee(id)
{
    ...
    $.get('../get/student/info/'+id).then(function(res){
        console.log(res);
        $(".studentImg").attr('src', 'https://shineschoolapp.com/'+res.data['avatar']);
...
$('.print').click(function(){
    var innerContents = document.getElementById('printReciept').innerHTML;
        ...
        popupWinindow.document.write('<html><head><link rel="stylesheet" type="text/css" href="https://shineschoolapp.com/users/css/bootstrap/bootstrap.min.css" /><link rel="stylesheet" type="text/css" href="users/assets/styles.css" /></head><body onload="window.print()">' + innerContents + '</html>');
...
/********* updated 25-10-2017  by priya ***********/
 ...
 /********* updated 07-11-2017  by priya ***********/
    ...
    $(".payment_bonus_value").change(function()
    {
        //alert(123);
        var srteacher =  $(".payroll_teacher").val();
        var payment_day =  $(".payment_day").val();
                ...
                function(data)
                {
                   ...
                   /*updated 16-3-2018*/
                    ...
                    if(data.employee_pTax)
                    {
                        ...
                        {
                            var prof_tax = Math.round(gross *( data.employee_pTax[row3]['tax'] / 100))  ;
                        }
                    }
                    ...
                    if(data.employee_deductions)
                    {
                        ...
                        {
                            var getTotalPercent = data.employee_deductions[row4]['total_deduction_percent'] ;
                        }
                    }
                   // var deduction = Math.round(gross *( getTotalPercent / 100));
                   /*updated 16-3-2018*/
