        ...
        else
        {
            $.post("../get/teacher/library",
            {
                ...
                else
                {
                    ...
                    cont+="<tr><th>User Name</th><td>"+data.teacher['username']+"</td></tr>";
        ...
        else
        {
            $.post("../get/student/library",
            {
                ...
                else
                {
                    ...
                    cont+="<tr><th>Student Name</th><td>"+data.student['name']+"</td></tr>";
                    cont+="<tr><th>Roll No</th><td>"+data.student['roll_no']+"</td></tr>";
                    cont+="<tr><th>Admission No</th><td>"+data.student['registration_no']+"</td></tr>";
                    cont+="<tr><th>Class</th><td>"+data.student['class']+"</td></tr>";
                    cont+="<tr><th>Section</th><td>"+data.student['section']+"</td></tr>";
                    cont+="</table></div></div>";

                    cont+="<div class='row' style='margin-left:3%'><div class='col-md-6'><table class='table table-bordered table-condensed'><tr><th>Acc No</th><th>Subject</th><th>Issue Date</th><th>Return Date</th></tr>";
                    for(me in data.library)
                    {
                        cont+="<tr><td>"+data.library[me]['book_no']+"</td>";
                        cont+="<td>"+data.library[me]['subject']+"</td>";
...
/*********************************************************************
     *                        home visit report
     *********************************************************************/
    $(".rephomevisitclass").change(function()
    {
        var srclass =  $(".rephomevisitclass").val();
        if(srclass!="")
        {
            $.post("../gethomevisitrep/student/section/ajax",
                {
                    srclass:srclass
                },
                function(data)
                {
                    $(".rephomevisitsection").removeAttr('disabled');
                    var cont="<select class='form-control rephomevisitsection' name='section'><option value=''>Select Section</option>";
                    for(me in data)
                    {
                        cont+= "<option value='"+data[me]['id']+"'>"+data[me]['section']+"</option>";
                    }
                    $('.rephomevsection').html(cont+"</select>");
                });
        }
    });
     ...
     *                        canvash report
     *********************************************************************/
    $(".creportclass").change(function()
    {
        var srclass =  $(".creportclass").val();
        if(srclass!="")
        {
            $.post("../gethomevisit/report/section/ajax",
                {
                    srclass:srclass
                },
                function(data)
                {
                    $(".homecreportsection").removeAttr('disabled');
                    var cont="<select class='form-control homecreportsection' name='section'><option value=''>Select Section</option>";
                    for(me in data)
                    {
                        cont+= "<option value='"+data[me]['id']+"'>"+data[me]['section']+"</option>";
                    }
                    $('.creportsection').html(cont+"</select>");
                });
        }
    });
     ...
     *********************************************************************/
    $(".idpaymentclass").change(function()
    {
        var srclass =  $(".idpaymentclass").val();
        if(srclass!="")
        {
            $.post("../getid/student/section/ajax",
                {
                    srclass:srclass
                },
                function(data)
                {
                    $(".homeidpaymentsection").removeAttr('disabled');
                    var cont="<select class='form-control homeidpaymentsection' name='section'><option value=''>Select Section</option>";
                    for(me in data)
                    {
                        cont+= "<option value='"+data[me]['id']+"'>"+data[me]['section']+"</option>";
                    }
                    $('.idpaymentsection').html(cont+"</select>");
                });
        }
    });
    $(".idpaymentsection").change(function()
    {
        var srclass =  $(".idpaymentclass").val();
        var srsection =  $(".homeidpaymentsection").val();
        if(srclass!="")
        {
            $.post("../get/id/student/ajax",
                {
                    srclass:srclass,srsection:srsection
                },
                function(data)
                {
                    $(".homeidpaymentstudent").removeAttr('disabled');
                    var cont="<select class='form-control homeidpaymentstudent' name='student'><option value=''>Select Student</option>";
                    for(me in data)
                    {
                        cont+= "<option value='"+data[me]['id']+"'>"+data[me]['name']+"</option>";
                    }
                    $('.idpaymentstudent').html(cont+"</select>");
                });
        }
    });
    ...
    $(".buspaymentclass").change(function()
    {
        var srbus =  $(".buspaymentclass").val();
        
        
        if(srbus!="")
        {
            $.post("../../getfeebussss/student/section/ajax",
                {
                    srbus:srbus
                },
                function(data)
                {
                    ...
                    $(".homebusspaymentsection").removeAttr('disabled');
                    var cont="<select class='form-control homebusspaymentsection' name='routes' ><option value=''>Select Route</option>";
                    for(me in data)
                    {
                        cont+= "<option value='"+data[me]['id']+"'>"+data[me]['route_name']+"</option>";
                    }
                    $('.busspaymentsection').html(cont+"</select>");
                });
        }
    });
    $(".busspaymentsection").change(function()
    {
        var srbus =  $(".buspaymentclass").val();
        var srroute =  $(".homebusspaymentsection").val();
        if(srbus!="")
        {
            //alert(srroute);
            $.post("../../get/feebusess/student/ajax",
                {
                    srbus:srbus,srroute:srroute
                },
                function(data)
                {
                   
                    $(".homebuspaymentstudent").removeAttr('disabled');
                    var cont="<select class='form-control homebuspaymentstudent' name='board'><option value=''>Select Boarding</option>";
                    for(me in data)
                    {
                        cont+= "<option value='"+data[me]['id']+"'>"+data[me]['boarding']+"</option>";
                    }
                    $('.buspaymentstudent').html(cont+"</select>");
                });
        }
    });
    /*********************************************************************
     *                        single student Payment
     *********************************************************************/
    $(".viewpaymentclass").change(function()
    {
        var srclass =  $(".viewpaymentclass").val();
        //alert(srclass);
        if(srclass!="")
        {
            $.post("../../viewfee/student/section/ajax",
                {
                    srclass:srclass
                ...
                function(data)
                {
                    ...
                    $(".homeviewpaymentsection").removeAttr('disabled');
                    var cont="<select class='form-control homeviewpaymentsection' name='section'><option value=''>Select Section</option>";
                    for(me in data)
                    {
                        //alert(data);
                        cont+= "<option value='"+data[me]['id']+"'>"+data[me]['section']+"</option>";
                    }
                    $('.viewpaymentsection').html(cont+"</select>");
                });
        }
    });
    /*********************************************************************
     *                        single student Payment
     *********************************************************************/
    $(".svideoclass").change(function()
    {
        var srclass =  $(".svideoclass").val();
        if(srclass!="")
        {
            $.post("../getvideo/student/section/ajax",
                {
                    srclass:srclass
                },
                function(data)
                {
                    $(".homesvideosection").removeAttr('disabled');
                    var cont="<select class='form-control homesvideosection' name='section'><option value=''>Select Section</option>";
                    for(me in data)
                    {
                        cont+= "<option value='"+data[me]['id']+"'>"+data[me]['section']+"</option>";
                    }
                    $('.svideosection').html(cont+"</select>");
                });
        }
    });
    /*********************************************************************
    ...
    /*********************************************************************
     *                        view bus - route wise student
     *********************************************************************/
    $(".viewbuspaymentclass").change(function()
    {
        var srbus =  $(".viewbuspaymentclass").val();
       
        if(srbus!="")
        {
            $.post("../../viewgetfeebussss/student/section/ajax",
                {
                    srbus:srbus
                },
                function(data)
                {
                    //alert(data);
                    $(".homeviewbusspaymentsection").removeAttr('disabled');
                    var cont="<select class='form-control homeviewbusspaymentsection' name='routes' ><option value=''>Select Route</option>";
                    for(me in data)
                    {
                        cont+= "<option value='"+data[me]['id']+"'>"+data[me]['route_name']+"</option>";
                    }
                    $('.viewbusspaymentsection').html(cont+"</select>");
                });
        }
    });