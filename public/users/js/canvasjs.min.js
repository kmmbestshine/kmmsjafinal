...
(function () {
    ...
    var J = {}, v = !!document.createElement("canvas").getContext, ea = {
            ...
            return function (l, k, n) {
                ...
                n = q ? "getUTC" : "get";
                var s = l[n + "Date"](), u = l[n + "Day"](), w = l[n + "Month"](), y = l[n + "FullYear"](),
                    t = l[n + "Hours"](), v = l[n + "Minutes"](), aa = l[n + "Seconds"](), ca = l[n + "Milliseconds"](),
            ...
            d = String(d);
            var h = 1, l = b = "", k = -1, n = [], m = [], p = 0, e = 0, r = 0, q = !1, s = 0,
                l = d.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            d = null;
            ...
            return {x: d, y: b}
        }, Na = !0, Ba = window.devicePixelRatio || 1, ua = 1, P = Na ? Ba / ua : 1,
    ...
    z.prototype._plotAreaMouseUp = function (a, d) {
        if (("normal" === this.plotInfo.axisPlacement ||
            ...
            var b = d - this.dragStartPoint.y, c = a - this.dragStartPoint.x, f = 0 <= this.zoomType.indexOf("x"),
    ...
    z.prototype._plotAreaMouseMove = function (a, d) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            var b = 0, c = 0, f = b = null, f = 0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"),
                h = this;
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled)) if (this.panEnabled) f = {
                ...
                var c = f ? this.dragStartPoint.x : this.plotArea.x1, l = g ? this.dragStartPoint.y : this.plotArea.y1,
    ...
    z.prototype.renderIndexLabels = function (a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            var n = this._indexLabels[a], m = n.chartType.toLowerCase(), p, e,
            ...
            var h = S("indexLabelFontWeight", n.dataPoint, n.dataSeries),
                ...
                w = {percent: null, total: null}, y = null;
            ...
            if (null !== t && "" !== t) {
                var w = S("indexLabelPlacement", n.dataPoint, n.dataSeries),
                    y = S("indexLabelOrientation", n.dataPoint, n.dataSeries), C = n.direction, aa =
    ...
    z.prototype.renderColumn = function (a) {
        var d = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = 0, g, h, l,
    ...
    z.prototype.renderStackedColumn = function (a) {
        var d = a.targetCanvasCtx ||
            this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = [], g = [], h = [], l = 0, k,
    ...
    z.prototype.renderStackedBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b =
                    null, c = this.plotArea, f = [], g = [], h = [], l = 0, k,
                n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1,
                ...
                if (0 < q.length) {
                    ...
                    for (l = 0; l < q.length; l++) if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
                        var c = a.axisX.convertValueToPixel(b),
                            u = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, w = u + p << 0, y;
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < q.length) {
                    var s = 5 < p && r.bevelEnabled ? !0 : !1;
                    d.strokeStyle = "#4572A7 ";
                    for (l = 0; l < q.length; l++) if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" ===
                        typeof q[l].y) {
    ...
    z.prototype.renderArea = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = this._eventManager.ghostCtx, f = a.axisX.lineCoordinates, g = a.axisY.lineCoordinates, h = [],
                l = null, k = this.plotArea;
            b.save();
            v && c.save();
            b.beginPath();
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                c.fillStyle = h;
                var h = [], e = !0, r = 0, q, s, u,
                    w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y, t = null;
                if (0 < p.length) {
                    ...
                    var z = "solid";
                    if (b.setLineDash) {
                        var A = F(m.nullDataLineDashType, m.lineThickness), z = m.lineDashType,
    ...
    z.prototype.renderSplineArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                c.fillStyle = h;
                var h = [], e = 0, r, q,
                    s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u, w = null,
                    y = [];
                if (0 < p.length) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < p.length) {
                    ...
                    var Q = "solid";
                    if (b.setLineDash) {
                        var K = F(m.nullDataLineDashType, m.lineThickness), Q = m.lineDashType,
    ...
    z.prototype.renderStackedArea = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, f = [], g = null, h = this.plotArea, l = [], k = [], n = [], m = [], p = 0, e, r, q,
    ...
    z.prototype.renderStackedArea100 = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, f = this.plotArea, g = [], h = null, l = [], k = [], n = [], m = [], p = 0, e, r, q,
                s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                u = this._eventManager.ghostCtx;
            b.save();
            v && u.save();
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var m = 0, p = 0, c = 0; c < n.length; c++) if (f = n[c].getTime ? f = n[c].x.getTime() : f = n[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" ===
                        typeof n[c].y) {
                        f = a.axisX.convertValueToPixel(f);
    ...
    z.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, c = this.plotArea, f = 0, g, h, l, k, n, m,
                f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < s.length) for (var u = 5 < p && q.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++) if (s[f].getTime ? m = s[f].x.getTime() : m = s[f].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                    ...
                    var w = g - p / 2 << 0, y = w + p << 0, c = s[f].color ? s[f].color : q._colorSet[0],
                        t = Math.round(Math.max(1, 0.15 * p)), x = 0 === t % 2 ? 0 : 0.5, z = q.dataPointIds[f];
    ...
    z.prototype.renderRangeColumn = function (a) {
        var d = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = 0, g, h,
                f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
    ...
    z.prototype.renderPie = function (a) {
                        ...
                        if (null !== h) {
                            ...
                            if (l = 0 > z) {
                                ...
                                var n = w.indexLabelTextBlock.y - w.indexLabelTextBlock.height /
                                    2, q = w.indexLabelTextBlock.y + w.indexLabelTextBlock.height / 2,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var n = this.data[a.dataSeriesIndexes[0]],
                m = n.dataPoints, p = 10, e = this.plotArea, r = [], q = 2, s, u = 1.3, w = 20 / 180 * Math.PI, y = 6,
                t = {x: (e.x2 + e.x1) / 2, y: (e.y2 + e.y1) / 2}, v = 0;
            a = !1;
    ...
    oa.prototype.render = function () {
        if (this.text) {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(),
                b = d.x1, c = d.y1, f = 0, g = 0,
                h = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, l, k;
    ...
    ya.prototype.render = function () {
        var a = this.dockInsidePlotArea ?
            this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), b = null, c = 0, f = 0, g = 0, h = 0,
        ...
        for (var m = 0; m < this.dataSeries.length; m++) {
            ...
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                var e = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? ba.getDefaultLegendMarker(p.type) :
                    ...
                    r = this.chart.replaceKeywordsWithValue(r, p.dataPoints[0], p, m), e = {
                        markerType: e,
                        markerColor: q,
                        text: r,
                        textBlock: null,
                ...
                var t = p.dataPoints[v],
                    ...
                    r = this.chart.replaceKeywordsWithValue(r, t, p, v), e = {
                        markerType: e,
                        markerColor: q,
                        text: r,
                        textBlock: null,
    ...
    ba.prototype.getDataPointAtX = function (a, d) {
        ...
        var b = {dataPoint: null, distance: Infinity, index: NaN}, c = null, f = 0, g = 0, h = 1, l = Infinity, k = 0,
            n = 0, m = 0;
            ...
            if (0 <= g && g < this.dataPoints.length) {
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "scatter":
                            var s =
                                S("markerSize", r, this) || 4, u = b ? 20 : s,
    ...
    A.prototype.createLabels = function () {
        var a, d, b = 0, c = 0, f, g = 0, h = 0, c = 0, l = this.interval, k = 0, n, m = 0.6 * this.chart.height,
            b = !1;
    ...
    A.prototype.createLabelsAndCalculateWidth = function () {
        ...
        if ("left" === this._position || "right" === this._position) {
            ...
            for (d = 0; d < this._labels.length; d++) {
                var b = this._labels[d].textBlock, c = b.measureText(), f = 0,
    ...
    z.prototype.replaceKeywordsWithValue = function (a, d, b, c, f) {
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <=
                a.indexOf("#total"))) {
            var h = "#percent", l = "#total", k = this.getPercentAndTotal(b, d), l = isNaN(k.total) ? l : k.total,
