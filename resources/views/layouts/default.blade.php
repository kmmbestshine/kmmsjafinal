...
<head>
    ...
    <title>@yield('title') - Shine School</title>

    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Heebo:100%7COpen+Sans:300,400,400i,600,700,800">
    <!-- inject:css -->
    
    <link rel="stylesheet" href="{{url('assets/css/plugins.css')}}">
    <link rel="stylesheet" href="{{url('assets/css/alien.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('assets/css/style.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{url('assets/css/bootstrap.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{url('assets/css/bs-slider.css')}}" />
...
<body>
        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed bootsnav">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="{{url('assets/imgs/logo.png')}}" class="logo logo-scrolled" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="" data-out="">
                        <li>
                            <a href="{{route('/')}}" class="dropdown-toggle" data-toggle="dropdown" >Home</a>
                        ...
                        <li>
                            <a href="{{route('value')}}" >Value Proposition</a>
                        </li>
            ...
            <div class="side">
                ...
                <div class="widget">
                    ...
                    <ul class="link">
                        ...
                        <li><a href="{{route('value')}}">Value Proposition</a></li>
                        <li><a href="{{route('bcpRegistration')}}">Become a Channel Partner</a></li>
    ...
    <!--<footer class="u-PaddingTop100 u-xs-PaddingTop30">
        <div class="container text-center text-sm">
            <img class="retina" src="{{url('assets/imgs/logo-colored.png')}}" alt="">
...
<footer>
  ...
  <div class="copyright">
    ...
    <script src="{{url('assets/js/alien.min.js')}}"></script>
<script type="text/javascript" src="{{url('assets/js/bs-slider.js')}}"></script>
