                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                        <div class="col-md-5 col-sm-5 col-xs-12 form-group top_search" style="padding-left: 50px;">
                            <div class="input-group">
                                <a href="{{route('acc.create.bankacc')}}" class="btn btn-success">Add Bank Account</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{route('acc.post.expense')}}" method="post">
                      {{ csrf_field() }}
                      <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          <label for="name" class="col-md-4 control-label">@lang('Category Name')</label>

                          <div class="col-md-6">
                              <select  class="form-control" name="sectorname">
                      ...
                      <div class="form-group{{ $errors->has('income_source') ? ' has-error' : '' }}">
                          <label for="income_source" class="col-md-4 control-label">@lang('Paid To'): </label>
                      ...
                      <div class="form-group{{ $errors->has('income_source') ? ' has-error' : '' }}">
                          <label for="income_source" class="col-md-4 control-label">@lang('Cash Deposit To Bank'): </label>

                          <div class="col-md-6">
                             <select  class="form-control" name="cash_deposit">
