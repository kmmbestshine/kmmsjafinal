    ...
    <div class="receipt-main col-xs-10 col-sm-10 col-md-8 col-xs-offset-1 col-sm-offset-1 col-md-offset-2" id="paymentRecipt">
        ...
        <div >
            <table class="table table-striped table-bordered table-hover" >
                ...
                <tbody>
                	<?php $j=1; ?>
                	<?php for($i=0; $i<count($idNos); $i++) : ?>
                    <tr>
                   <td ><?php echo  $j++ ?></td>
                  <td >{{$date[$i]}}</td><br>
                  <td >{{$user_type}}</td><br>
                  <td ><i class="fa fa-inr"></i>  {{$LabourStr_Amt[$i]}}/-</td>
                    </tr>
                    <?php endfor ?>
                    
                    <tr>                     
                        <th></th><th></th><td class="text-right"><h4><strong>Payable Amount: </strong></h4></td>
                        <td class="text-left text-danger"><h5><strong><i class="fa fa-inr"></i> {{ $payableAmt }}/-</strong></h5></td>
                    </tr>
                    <tr>
