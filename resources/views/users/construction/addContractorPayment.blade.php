...
@section('contant')
    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" role="form" method="post" action="{{route('post.construct.paymentstr')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Add Payment</strong></h3>
                            <div class="text-right">
                                <a href="{{route('get.dailywages')}}" class="btn btn-info btn-rounded">View Wages</a>
                            </div>
                        </div>
