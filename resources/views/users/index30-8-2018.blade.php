            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="height:216px; overflow-y: auto;">
                        ...
                        <form action="{{ route('birthday.notification') }}" method="post">
                                {!! csrf_field() !!}
                            ...
                            <table>
                                <tbody>
                                <tr>
                                    <textarea rows="3" cols="40" name="content" placeholder="Enter Description"></textarea>
                                </tr>
                                </tbody>
                            </table>
                            <div class="row text-right">
                                <!-- <a href="/users/dashboard/send/birthday-notification">
                                    <button type="button" class="btn btn-info">Send Wishes To All</button></a> -->
                                    <button type="submit" class="btn btn-info">Send Wishes To All</button>
                            </div>
                            </form>
                        @else
                            <center>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading colorHeader">
                            <div class="panel-title-box">
                                <h3>Class Attendance - Taken Chart</h3>
                                <span>Today </span>
                            </div>                                    
                        </div>                                
                        <div class="panel-body padding-0 attendance" style="color:orange !important;overflow: scroll;">
                            <div class="chart-holder" id="dashboard-bar-1"
                                 style="height: 200px;color:orange !important;"></div>
                        </div>      
                 ...
                 <!-- <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading colorHeader">
                            <div class="panel-title-box">
                                <h3>Class Attendance - Not Taken Chart</h3>
                                <span>Today </span>
                            </div>                                    
                        </div>                                
                        <div class="panel-body padding-0 attendancenot" style="color:orange !important;overflow: scroll;">
                            <div class="chart-holder" id="dashboard-bar-2" style="height: 200px;color:orange !important;"></div>
                        </div>      
