                        ...
                        <div class="panel-heading">
                            ...
                            <div class="text-right">
                               <a href="{{route('master.student')}}" class="btn btn-info btn-rounded">New Admission</a>
                                &nbsp;&nbsp;&nbsp;
                                <a href="{{route('search.studentlist')}}" class="btn btn-info btn-rounded">Search Student</a>
                                &nbsp;&nbsp;&nbsp;
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                 ...
                                 <div class="col-md-2">
                                        <a href="{{route('get.students')}}" class="btn btn-info btn-lg">Refresh</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach($students as $key => $student)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('delete.student', $student->id)}}" class="btn btn-danger" target="_blank" onclick="return confirm('Are You Sure, Delete Student?')">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
