...
@section('contant')
    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" role="form" method="post" action="{{route('post.homework')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Add Homework</strong></h3>
                            <div class="text-right">
                                <a href="{{route('get.homework')}}" class="btn btn-info btn-rounded">View Today's Homework</a>
                                <a href="{{route('user.smssend')}}" class="btn btn-info btn-rounded">Text Sms Homework</a>
                            </div>
                        </div>
