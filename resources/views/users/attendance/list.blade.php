                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="text-right">
                                <a href="{{route('user.attendance')}}" class="btn btn-info btn-rounded">Add Attendance</a>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <strong>View Attendance of Class {{ $classData->class}} of Section {{ $sectionData->section }}</strong>
                            </h3>
                            <div class="text-right">
                                <?php $session = date('a');  ?>
                                <a href="{{route('update_student_attendace',[$classData->id,$sectionData->id,$session])}}" class="btn btn-info btn-rounded">Update Attendance</a>
                            </div>
                        </div>
                        <div class="panel-body">
