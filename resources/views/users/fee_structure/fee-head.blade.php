...
@section('title', 'Fee Head Amount')
@section('cram')
<ul class="breadcrumb">
    <li><a href="{{route('user.dashboard')}}">Home</a></li>
    <li class="active">Fee Head Amount</li>
</ul>
@endsection
@section('contant')
<div class="page-title">                    
    <h2><span class="fa fa-arrow-circle-o-left"></span> Fee Head Amount</h2>
</div>
                ...
                <div class="block">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">      
                                <div class="col-md-6">
                                    <p style="color:red;">Enter Monthly Amount</p>
                                    <form action="{{route('feeHeadAmountPost')}}" method="post">
                                        {!! csrf_field() !!}
                                        <div class="form-group">
                                            <select name="fee_head_type" id="head_type" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" id="head" name="fee_head" required>
                                                <option>Choose Fee Head</option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @if($fee_amount)
                                            @foreach($fee_amount as $key=>$amount)
                                            <tr>
                                                <td>{{$key+1}}</td>
                                                <td>{{$amount->class}}</td>
                                                <td>{{$amount->fee_head}}</td>
                                                <td>{{$amount->amount}}</td>
                                                <td><a href="{{route('feeHeadAmountDelete', $amount->id)}}" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
