...
@section('title', 'Student Wise Fee')
@section('cram')
<ul class="breadcrumb">
            	...
            	<form class="form-horizontal" role="form" method="post" action="{{route('fee.add.sion.studentmapping')}}" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Student Wise Fee</strong></h3>
                        </div>
                        				...
                        				<div class="col-md-12">
                        					<div class="form-group">
                        						<select name="data" class="form-control">
                        							...
                        							<option value="studentmapping">Student - Bus Mapping</option>
                        			...
                        			<div class="col-md-12">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <a href="{{url('data-manager/studentmapping.xlsx')}}" class="btn btn-info">Student - Bus Mapping Sample File</a>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <a href="{{url('data-manager/studentfees.xlsx')}}" class="btn btn-info">Student Fees Sample File</a>
                                                    </div>
