               ...
               <form class="form-horizontal" role="form" method="post" action="" > 
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Add Fee </strong></h3>
                            <div class="text-right">
                                <a href="{{ route('fee.view.sion.structure') }}"  class="btn btn-info btn-rounded">View Fees </a>
                            </div>
                        </div>
                        ...
                        <br/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-info btn-lg">Add Fee </button>
                                </div>
                            </div>
                        </div>
                    </div>
