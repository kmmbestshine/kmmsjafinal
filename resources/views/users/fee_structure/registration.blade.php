...
@section('title', 'Registration Amount')
@section('cram')
<ul class="breadcrumb">
...
<div class="page-title">                    
    <h2><span class="fa fa-arrow-circle-o-left"></span> Registration Amount</h2>
</div>
                        ...
                        <div class="panel-body">
                            <div class="row">      
                                <div class="col-md-6">
                                    ...
                                    <form action="{{route('feeregistrationPost')}}" method="post">
                                        {!! csrf_field() !!}
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$amount->class}}</td>
                                                <td>{{$amount->amount}}</td>
                                                <td><a href="{{route('registration.Delete', $amount->id)}}" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
