      ...
      <p align="right"><b>Date : {{date('d-m-Y')}} </b></p>
        ...
        <div >
            <table class="table table-striped table-bordered table-hover" >
                ...
                <tbody>
                  <p > &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp   This is to certify that @if($teacherdetails->gender =='Male') {{ $mr }} @else {{ $mrs }} @endif.<b>{{$teacherdetails->name}} </b>has been working as a <b>{{$teacherdetails->designation}}</b> from <b>{{$from}}</b> to <b>{{$to}}</b> in Our School.</p>
                          
                          <p>During @if($teacherdetails->gender =='Male') {{ $his }} @else {{ $her }} @endif above tenure we found @if($teacherdetails->gender =='Male') {{ $his }} @else {{ $her }} @endif to be regular, honest and diligent in duties and responsibilities, and @if($teacherdetails->gender =='Male') {{ $he }} @else {{ $she }} @endif has been relieved from @if($teacherdetails->gender =='Male') {{ $his }} @else {{ $her }} @endif service as per @if($teacherdetails->gender =='Male') {{ $his }} @else {{ $her }} @endif request.</p>
                          <p>We wish @if($teacherdetails->gender =='Male') {{ $his }} @else {{ $her }} @endif every success in all his/her future endeavours.</p>
