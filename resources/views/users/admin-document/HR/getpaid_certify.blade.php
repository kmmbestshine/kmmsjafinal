...
@section('title', 'School Fees Paid Certificate')
@section('cram')
    <ul class="breadcrumb">
        <li><a href="{{route('user.dashboard')}}">Home</a></li>
        <li class="active">School Fees Paid Certificate</li>
    </ul>
@endsection
@section('contant')
    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
               <form class="form-horizontal" role="form" method="post" action="{{route('documents.feepaid.hr.certify')}}" > 
                
                    {!! csrf_field() !!}
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>School Fees Paid Certificate</strong></h3>
                          ...
                          <!--  <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <button type="submit" class="btn btn-info btn-lg">Get School Fees Paid Certificate</button>
                                </div>
                            </div>
                        </div>
                    </div>
