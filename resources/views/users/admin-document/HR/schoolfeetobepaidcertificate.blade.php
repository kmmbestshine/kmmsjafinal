...
<hr>
    <h3 style="text-align: center;"><u>SCHOOL FEES TO BE PAID CERTIFICATE</u></h3>
    ...
    <div class="content"> <!-- use this div only if it is required for styling -->
        ...
        <p>
        	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspHe / She has to pay a sum of Rs.{{$input['amt']}} in words ({{$input['amt_words']}}) as Tuition fees and all other fees inclusive of all for the academic year {{$session->session}}. 
