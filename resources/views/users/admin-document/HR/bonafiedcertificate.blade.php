...
<hr>
    <h3 style="text-align: center;"><u>BONAFIDE CERTIFICATE</u></h3>
    ...
    <div class="content"> <!-- use this div only if it is required for styling -->
        <p>
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspThis is to certify that Thiru / selvi  {{$student->student_name}} S/o / D/o {{$student->parent_name}} residing at {{$student->address}} is/was a bonafide student of our school studied from {{$fromclass->class}} standard to {{$toclass->class}} standard from the academic year {{$input['fromyear']}} to {{$input['toyear']}}
        </p>
        <p>
        	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspHis / her date of birth according to our school’s Admission Register is {{$student->dob}} and his/her admission number is {{$input['regno']}}.
        </p>
        <p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspThis certificate is issued for the purpose of {{$input['purpose']}}.</p>
      </div>
		<div class="row">
