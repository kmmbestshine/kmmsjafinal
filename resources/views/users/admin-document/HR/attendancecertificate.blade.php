...
<hr>
    <h3 style="text-align: center;"><u>ATTENDANCE CERTIFICATE</u></h3>
    ...
    <div class="content"> <!-- use this div only if it is required for styling -->
        ...
        <p>
        	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspHis / her percentage of attendance during the academic year {{$session->session}} is {{$input['percentage']}}%.
        </p>
      </div>
		<div class="row">
