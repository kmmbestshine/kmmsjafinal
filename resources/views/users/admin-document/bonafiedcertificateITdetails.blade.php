      ...
      <p align="right"><b>Date : {{date('d-m-Y')}} </b></p>
        ...
        <div >
            <table class="table table-striped table-bordered table-hover" >
                ...
                <tbody>
                  <p >This is to certify that <b>{{$students->name}}</b> S/O / D/O of <b>{{$parents->name}} </b> is a bonafied student of this school studying in <b>{{$class->class}}</b> Std  during the academic year {{$session->session}}.</p>
                           &nbsp&nbsp
                        &nbsp&nbsp
                          <p> He / She had paid a sum of Rs.{{$amount}}/- as tution fees for the academic year {{$session->session}}.</p>
