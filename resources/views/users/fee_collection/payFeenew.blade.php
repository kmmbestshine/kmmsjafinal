				...
				<div class="col-md-offset-2 col-md-8">
					...
					<div class="row form-group">
						...
						<div class="col-md-6">
							...
							@elseif($fee->payment_type == "PREVIOUS YEAR PAYMEN" || $fee->payment_type == "SINGLE PAYMENT")
										<input type="text" id="recivedAmount" name="recivedAmount" class="form-control" value="0" required />
										<span class="received-amount-error"></span>
									@else
					...
					@if($fee->payment_type == "PREVIOUS YEAR PAYMEN" || $fee->payment_type == "SINGLE PAYMENT" || $fee->payment_type == "ONE TIME" || count($installments) > 0)
						<!-- calculate late fee -->
						@if($last_paid_date == 0)
							<?php 
							$today = date('Y-m-d');
...
$(document).ready(function(){
    ...
    $('.print-submit').click(function() {
        ...
        // ONE TIME
        if(feeType == "ONE TIME" || feeType == "PREVIOUS YEAR PAYMEN" || feeType == "SINGLE PAYMENT"){
