        ...
        <div >
            <table class="table table-striped table-bordered table-hover" >
                ...
                <tbody>
                  ...
                  <td >{{$termsNo[$i]}}</td><br>
                  <td >{{$feenames[$i]}}</td><br>
                  <td ><i class="fa fa-inr"></i>  {{$feeamts[$i]}}/-</td>
                    </tr>
                    <?php endfor ?>
                   <!-- <tr>
                    ...
                    <tr>                     
                        <th></th><th></th><td class="text-right"><h4><strong>Total(Paid Amount): </strong></h4></td>
                        <td class="text-left text-danger"><h5><strong><i class="fa fa-inr"></i> {{ $received_amt }}/-</strong></h5></td>
                    </tr>
                </tbody>
            </table>
        </div>
