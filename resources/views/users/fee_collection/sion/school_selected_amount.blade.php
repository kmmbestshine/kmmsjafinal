                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%"><b>{{$fee_name[$i]}}</b><input type="hidden" value="{{$fee_name[$i]}}" name="feenames[]"><br></td> 
                                             ...
                                             <input type="hidden" value="{{ $route[$i] }}" name="route[]">
                                            <input type="hidden" value="{{ $bus_no[$i] }}" name="bus_no[]">
                                            <input type="hidden" value="{{ $board1[$i] }}" name="board[]">
                                             <input type="hidden" value="{{ $route_id[$i] }}" name="route_id[]">
                                            <input type="hidden" value="{{ $bus_id[$i] }}" name="bus_id[]">
                                            <input type="hidden" value="{{ $board_id[$i] }}" name="board_id[]">
