...
<div class="page-title">                    
    <h2><span class="fa fa-arrow-circle-o-left"></span> School Overall Report</h2>
</div>
                    ...
                    <div class="block">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">School Overall Report</h3>
                            </div>
                            <div class="panel-body">
                            	<form class="form-horizontal" method="post" action="{{route('school.fee.overall.reportdet')}}">
                                    {!! csrf_field() !!}
                                ...
                                <button style="margin-top:20px" class="pull-right btn btn-info">Create Overall Report</button>
                            </form>
                        </div>
                    </div>
                </div>
