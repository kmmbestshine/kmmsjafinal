...
<div class="page-title">                    
    <h2><span class="fa fa-arrow-circle-o-left"></span> Balance Report</h2>
</div>
                    ...
                    <div class="block">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Balance Report</h3>
                            </div>
                            <div class="panel-body">
                            	<form class="form-horizontal" method="post" action="{{route('new.fee.term.class.balancereport')}}">
                                    {!! csrf_field() !!}
                              ...
                              <!--  <div class="col-md-6" style="margin-top:10px">
                                ...
                                <button style="margin-top:20px" class="pull-right btn btn-info">Create Balance Report</button>
                            </form>
                        </div>
                    </div>
                </div>
