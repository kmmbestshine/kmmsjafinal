...
<div class="page-title">                    
    <h2><span class="fa fa-arrow-circle-o-left"></span> Received Report</h2>
</div>
                    ...
                    <div class="block">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Staff Received Report</h3>
                                <!-- <div class="text-right">
                                    <a href="{{route('list.structure')}}" class="btn btn-info btn-rounded">View</a>
                                </div>  -->
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="{{route('school.received.reportdetails')}}">
