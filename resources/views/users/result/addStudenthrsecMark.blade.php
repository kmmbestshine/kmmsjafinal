...
@section('contant')
            ...
            <div class="col-md-12">
                @if($getStudents)
                    <div class="panel panel-default">
                        ...
                        <form action="{{ route('postStudenthrsecResult') }}" method="post">
                            {!! csrf_field() !!}
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <!--  @if($student->absent_student)
                                                                    ...
                                                                    <input class="obtained_marks" name="obtained_marks[]" style="border: none;background-color: transparent;"
                                                                               id="obtained_marks_{{ $student->id }}" type="text"  disabled="disabled"  >  
                                                                        @else
                                                                        <input class="obtained_marks" name="obtained_marks[]" style="border: none;background-color: white;"
                                                                               id="obtained_marks_{{ $student->id }}" type="text" placeholder="Enter Obtained Marks" autocomplete="off"
                                                                                onchange="return getGradeSystem(this.id, this.value)"  >
                                                                        @endif
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <input class="theory_marks" id="theory_marks_{{ $student->id }}" name="theory_marks[]" style="border: none;background-color: white;" type="text" placeholder="Enter Theory Marks" autocomplete="off" onkeyup="markCalculation({{ $student->id }})">
                                                                  ...
                                                                  <!--  @if($student->absent_student)
                                                                    ...
                                                                    @else
                                                                    <input class="practical_marks" id="practical_marks_{{ $student->id }}" name="practical_marks[]" style="border: none;background-color: white;" type="text" placeholder="Enter Practical Marks" autocomplete="off" onkeyup="markCalculation({{ $student->id }})">
                                                                    @endif
    ...
    <script>
        ...
        function markCalculation(id){
            var mark1 = $('input[id="practical_marks_'+id+'"]').val();
            var mark2 = $('input[id="theory_marks_'+id+'"]').val();
        ...
        function getGradeSystem(id,value)
        {
           ...
           // alert(student_id);
            ...
            {
                $('.result_'+student_id).html("<input value='You Cannt leave the field empty'  style='border: none;background-color: transparent;color:#ff0000;' id='result' disabled='disabled' >");
            }
        }
