...
<div class="invoice">
        <div >
            ...
            <thead>
                <tr>
                    ...
                    <th align="center">Theory Mark</th>
                    <th align="center">Prac Mark</th> 
            ...
            <tbody>
				@foreach($students->result as $rel)
					<tr>
						...
						<td align="center">{{ $rel->theory_marks }}</td>
                        <td align="center">{{ $rel->practical_marks }}</td>
    ...
    <table width="100%">
        <tr>
            ...
            <td align="left" style="width: 40%;">
                <h3> .</h3>
                <p><b>Total No. Of Days Present: </b> </p>
                <p><b></b> </p>
                <p><b></b> </p>
                <p><b></b> </p>
            </td>
