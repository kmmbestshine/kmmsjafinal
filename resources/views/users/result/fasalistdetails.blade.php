...
<ul class="breadcrumb">
    ...
    <li class="active">View Result1</li>
</ul>
@endsection
@section('contant')
                                ...
                                <tbody>
                                    @foreach($students as $key => $result)
                                        ...
                                        <tr>
                                            ...
                                            <td><table class="table table-borderd table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{$result->totalFAMarks}}</td>
                                                            <td>{{$result->totalSAMarks}}</td>
                                            ...
                                            <td><a href="{{route('fasaresultDownload', [$class_id, $section,$exam, $result->id ])}}" class="btn btn-primary"><i class="fa fa-print"></i> Download</a></td>
