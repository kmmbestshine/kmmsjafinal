                                                            ...
                                                            @foreach($getPassMarks as $pass)
                                                                <tr>
                                                                    ...
                                                                    @if($student->id == $student->absent_student)
                                                                        <input class="faobtained_marks" name="faobtained_marks[]" style="border: none;background-color: transparent;"
                                                                    ...
                                                                    <td>
                                                                    @if($student->id == $student->absent_student)
                                                                        <input class="saobtained_marks" name="saobtained_marks[]" style="border: none;background-color: transparent;"
                                                                          value="AB" id="saobtained_marks_{{ $student->id }}"  disabled="disabled"  >
                                                                        <input type="hidden" class="saobtained_marks" name="saobtained_marks[]" value="AB" id="saobtained_marks_{{ $student->id }}" >
