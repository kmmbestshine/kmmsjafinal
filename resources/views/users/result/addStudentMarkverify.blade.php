                        ...
                        <div class="panel-body">
                            <div class="table-responsive">{{-- updated --}}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    @else
                                                                        <input class="obtained_marks" name="obtained_marks[]" style="border: none;background-color: white;"
                                                                            id="obtained_marks_{{ $student->id }}" type="text" value= "{{$obtaiend_marks[$key]}}"    placeholder="Enter Obtained Marks" autocomplete="off"
                                                                    ...
                                                                    <td class="grade_{{ $student->id }}">
                                                                        {{$grade[$key]}}
                                                                        <input   name="grade[]" value="{{ $grade[$key] }}" id="grade" type="hidden" >
                                                                    </td>
                                                                    <td class="result_{{ $student->id }}">
                                                                        {{$result[$key]}}
                                                                        <input   name="result[]" value="{{ $result[$key] }}" id="result" type="hidden" >
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        @endif
                                ...
                                <center>
                                    ...
                                    <input type="hidden" class="examtype" name="examtype" id="examtype" value="{{ $exam_type }}">
                                    <input type="hidden" name="getExamDate" value="{{ $exam_date}}">
                                    <label for="terms_and_conditions">Click for Enable Submit Button</label>
