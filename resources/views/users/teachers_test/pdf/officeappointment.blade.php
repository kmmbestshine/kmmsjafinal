...
<hr>
    ...
    <div class="content"> <!-- use this div only if it is required for styling -->
        <p>
          ...
          <br class="salution" />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With reference to the interview dated {{$bio_selected->created_at}}, we are pleased to offer you an appointment in one of our esteemed institutes {{ $school->school_name }}, {{ $school->address }} as an OFFICE / ADMIN STAFF handling OFFICE RELATED WORKS with effect from {{$bio_selected->doj}} under the following terms and conditions as mentioned below and in annexure herewith attached.
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered table-hover" >
			                ...
			                <tbody>
			                  ...
			                  <td >1.	You will be an OFFICE / ADMIN STAFF, handling OFFICE RELATED WORKS assigned for {{ $school->school_name }}, {{ $school->address }}.</td>
			                    </tr>
			                    <tr>
			                  ...
			                  <td >3.	You will be on CONTRACT for an approximately period of TWO YEARS from {{$bio_selected->doj}} </td>
			                    </tr>
			                    <tr>
			                  ...
			                  <td >5.	You will be drawing a monthly gross salary of Rs. {{$bio_selected->salary}}/- inclusive of all such as EPF contributions etc. </td>
			                    ...
			                    <tr>
			                  <td >
			                  					6.	Strictly abide to the general rules and regulations as instructed by the school leader time to time.

			                  </td>
			                    </tr>
			                    <tr>
			                  <td >
			                  	7.	Strictly co-operate with the management/school leader in all respect and keep her/him fully informed on all activities related and involved in the school campuses.
			                  </td>
			                    </tr>
			                     <tr>
			                  <td >
			                  		8.	Strictly maintain regularity and punctuality in attending school.		

			                  </td>
			                    </tr>
			                     <tr>
			                  <td >
			                  		9.	Complete the entire planning within the specified time and with strict punctuality.		

			                  </td>
			                    </tr>
			                     <tr>
			                  <td >
			                  		10.	Perform such other duties as may be prescribed by the school management / education department time to time.			

			                  </td>
			                    </tr>
			                     <tr>
			                  <td >
			                  		11.	All duties as promised by you verbally during your induction and interview should be performed without fail.			
			                    ...
			                    <tr>
			                  <td >
			                  		12.	Utmost important should be given to the FEES COLLECTION, RECORD MAINTAINING, STUDENTS ENROLLMENTS, VIRTUAL CLASS, ONLINE TESTS, etc. Professionalism should be exercised in complying these most important duties.			

			                  </td>
			                    </tr>
			                     <tr>
			                  <td >
			                  		13.	Needless to pen down everything that you need to perform. However the ultimate goal and focus should be on result oriented performance at the end of the academic year.			

			                  </td>
			                    </tr>
			                     <tr>
			                  <td >
			                  		14.	Your appointment will be confirmed only after you submit your following documents to the office.
