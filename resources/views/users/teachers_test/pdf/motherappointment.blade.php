...
<hr>
    ...
    <div class="content"> <!-- use this div only if it is required for styling -->
        <p>
          ...
          <br class="salution" />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With reference to the interview dated {{$bio_selected->created_at}}, we are pleased to offer you an appointment in one of our esteemed institutes {{ $school->school_name }}, {{ $school->address }} as MOTHER TEACHER handling {{$bio_selected->grade}} STANDARD with effect from {{$bio_selected->doj}} under the following terms and conditions as mentioned below and in annexure herewith attached.
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered table-hover" >
			                ...
			                <tbody>
			                  ...
			                  <td >1.	You will be a {{$bio_selected->designation}}, handling {{$bio_selected->grade}} STANDARD assigned for {{ $school->school_name }}, {{ $school->address }}</td>
			                    </tr>
			                    <tr>
