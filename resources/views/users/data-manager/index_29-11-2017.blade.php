                        	...
                        	<div class="row">
                        		...
                        		<div class="col-md-6">
                        			<div class="col-md-12">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h3 class="panel-title">Sample Files For Data Upload Manager</hz>
                                            </div>
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                ...
                                <div class="col-md-offset-6 col-md-6">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <p>1. All red colored colouns are mandatory fields</p>
                                                <p>2. you can get all coloum id number from export manager</p>
                                                <p>3. registation number must be unique on sessionwise</p>
