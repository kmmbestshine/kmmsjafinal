       ...
       <div class="page-title">                    
        ...
        <div class="page-content-wrap">
           <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        <form class="form-horizontal" role="form" method="post" action="{{route('post.religion')}}">
                            {!! csrf_field() !!}
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" name="religion" class="form-control" placeholder="Religion">
                                </div>
                                @foreach($errors->get('religion') as $religion)
                                    <div class="alert alert-danger">{{ $religion }}</div>
                                @endforeach
                            </div>
                                ...
                                <tbody>
                                    @foreach($religions as $key => $religion)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('edit.religion', $religion->id)}}" class="btn btn-info">Edit</a>
                                            </td>
                                            <td>
                                                <a href="{{route('delete.religion', $religion->id)}}" class="btn btn-danger" onclick="confirm('Are You Sure')">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
