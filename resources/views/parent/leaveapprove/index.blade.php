...
<style type="text/css">
    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" role="form" method="post" action="{{route('parent.leavePost')}}">
                    {!! csrf_field() !!}
                    ...
                    @foreach($leavesReq as $req)
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>{{$req[0]->name}} </strong>Leaves</h3>
                    </div>
                <div class="panel-body">
