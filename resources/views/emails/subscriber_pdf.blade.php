...
<div id="mailsub" class="notification" align="center">
    ...
    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px #bfbfbf">
        ...
        <tr>
            <td width="582" style="font-size:12px;font-family:Arial,Helvetica,sans-serif;line-height:18px;padding:10px">Dear User,<br><br>
               Thanks For Using St.Josephs School App
                <br>
                <br>
                <strong>
                    To respond back directly to the Customer Care, please click on Reply button, or send an email to
                    <br>
                    
                    <a href="mailto:info@bestshineeduapp.com">
                        info@bestshineeduapp.com
                    </a>
                </strong>
                <br>
                <br>For queries call +91-8929333444<br><br><br>
            </td>
        </tr>
        <tr>
            <td height="30" align="center" style="font-size:14px;font-family:Arial,Helvetica,sans-serif;line-height:18px;border-top:solid 1px #bfbfbf;padding:10px">
                <a href="http://stjosephspallalakuppam.in/assets/shineSchoolAppPPT.pptx"
                   style="font-size:15px;color:#fff;text-decoration:none;padding:10px 10px 10px 10px;display:inline-block;background:#337ab7;width:150px;text-align:center" >
                    Download Your PDF
                </a>
            </td>
        </tr>
